...
/**
 * CoursesPage.jsx
 * - Features: 15+ Mock Courses, Real Images, YouTube Links, Advanced Filtering
 */
...
const MOCK_COURSES = [
  // --- YOUTUBE COURSES (5) ---
  {
    ...
    image: "https://images.unsplash.com/photo-1629904853716-600abd17529c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
  ...
  },
  {
    ...
    author: "Daniel White",
    description: "Learn how to use Figma to design websites and mobile apps. Covers auto-layout, components, prototyping, and more.",
    numVideos: 15,
    estimatedHours: 4,
    price: 0,
    currency: "INR",
    ...
    category: "Design",
    externalUrl: "https://www.youtube.com/playlist?list=PL3lCAhAo7jXkY_h7xV_g-eE_W9-wQZ_7-",
    roadmap: [{ module: "Figma Basics", lessons: 5, hours: 2 }]
  },
  {
    id: "yt005",
    ...
    provider: "freeCodeCamp",
    author: "Kylie Ying",
    description: "Learn Machine Learning in a way that is accessible to everyone. No complex math required initially, focused on concepts.",
    numVideos: 1,
    estimatedHours: 4,
    price: 0,
    currency: "INR",
    ...
    externalUrl: "https://www.youtube.com/watch?v=i_LwzRVP7bg",
    roadmap: [{ module: "ML Concepts", lessons: 1, hours: 4 }]
  },
  ...
  // --- PAID COURSES (5) ---
  {
    ...
    level: "Beginner",
    language: "English",
    tags: ["Web Dev", "Fullstack", "Bootcamp"],
    rating: 4.8,
    reviewsCount: 250000,
    enrolledCount: 900000,
    ...
    category: "Development",
    roadmap: [{ module: "Frontend", lessons: 100, hours: 25 }, { module: "Backend", lessons: 80, hours: 20 }]
  },
  {
    id: "pd002",
    title: "Data Science A-Z™: Real-Life Data Science",
    type: "paid",
    ...
    level: "Intermediate",
    language: "English",
    tags: ["Data Science", "Tableau", "Stats"],
    rating: 4.6,
    reviewsCount: 40000,
    enrolledCount: 300000,
    lastUpdated: "2023-11-15",
    hasCertificate: true,
    hasLifetimeAccess: true,
    image: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    category: "Data Science",
    roadmap: [{ module: "Visualization", lessons: 20, hours: 5 }, { module: "Modeling", lessons: 30, hours: 8 }]
  },
  {
    id: "pd003",
    ...
    provider: "Skillshare",
    author: "Phil Ebiner",
    description: "Master Social Media Marketing, SEO, YouTube, Email, Facebook Marketing, Analytics and more!",
    numVideos: 300,
    estimatedHours: 32,
    price: 2999,
    currency: "INR",
    ...
    hasCertificate: true,
    hasLifetimeAccess: true,
    image: "https://images.unsplash.com/photo-1533750516457-a7f992034fec?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    category: "Marketing",
    roadmap: [{ module: "SEO", lessons: 50, hours: 10 }]
  },
  {
    id: "pd004",
    ...
    category: "Development",
    roadmap: [{ module: "Dart Basics", lessons: 20, hours: 5 }]
  },
  {
    id: "pd005",
    ...
    description: "Learn Adobe Photoshop CC from scratch. Design icons, business cards, illustrations, and characters.",
    numVideos: 100,
    estimatedHours: 15,
    price: 1999,
    currency: "INR",
    ...
    hasCertificate: true,
    hasLifetimeAccess: true,
    image: "https://images.unsplash.com/photo-1574717024653-61fd2cf4d44c?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    category: "Design",
    roadmap: [{ module: "Tools", lessons: 10, hours: 3 }]
  },
  ...
  // --- FREE COURSES (5) ---
  {
    ...
    description: "Understand how data is used to drive business decisions. Learn the basics of data analysis and visualization.",
    numVideos: 15,
    estimatedHours: 10,
    price: 0,
    currency: "INR",
    ...
    category: "Business",
    roadmap: [{ module: "Data Types", lessons: 5, hours: 2 }]
  },
  {
    id: "fr002",
    ...
    provider: "OpenLearn",
    author: "Google",
    description: "Learn the agile philosophy and the Scrum framework. Ideal for aspiring project managers.",
    numVideos: 20,
    estimatedHours: 12,
    price: 0,
    currency: "INR",
    level: "Beginner",
    language: "English",
    tags: ["Management", "Agile", "Business"],
    rating: 4.7,
    reviewsCount: 3000,
    enrolledCount: 60000,
    ...
    category: "Business",
    roadmap: [{ module: "Scrum", lessons: 8, hours: 4 }]
  },
  {
    id: "fr003",
    ...
    description: "Build a social media strategy that aligns with your business goals. Learn to create content that engages.",
    numVideos: 12,
    estimatedHours: 5,
    price: 0,
    currency: "INR",
    ...
    category: "Marketing",
    roadmap: [{ module: "Strategy", lessons: 4, hours: 2 }]
  },
  {
    id: "fr004",
    ...
    description: "Improve your communication skills for the workplace. Learn to speak confidently and listen effectively.",
    numVideos: 10,
    estimatedHours: 3,
    price: 0,
    currency: "INR",
    ...
    hasCertificate: false,
    hasLifetimeAccess: true,
    image: "https://images.unsplash.com/photo-1521791136064-7985c1d10093?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    category: "Business",
    roadmap: [{ module: "Listening", lessons: 3, hours: 1 }]
  },
  {
    id: "fr005",
    title: "Basics of Graphic Design",
    type: "free",
    provider: "Canva School",
    author: "Canva Team",
    description: "Learn the fundamental principles of design: contrast, balance, emphasis, and proportion.",
    numVideos: 8,
    estimatedHours: 2,
    price: 0,
    currency: "INR",
    ...
    hasCertificate: false,
    hasLifetimeAccess: true,
    image: "https://images.unsplash.com/photo-1626785774573-4b7993143a4d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3",
    category: "Design",
    roadmap: [{ module: "Principles", lessons: 4, hours: 1 }]
  }
];
...
export default function CoursesPage() {
  ...
  const handleEnroll = (course) => {
    if (course.type === 'youtube') window.open(course.externalUrl, '_blank');
    else {
